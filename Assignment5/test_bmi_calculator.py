...
def test_calculatorBMI():
    bmi = calculatorBMI(170, 5, 10)
    assert round(bmi, 1) == 22.5

def test_calculatorBMI_inches():
    bmi = calculatorBMI_inches(120, 70)
    assert round(bmi, 1) == 31.5

def test_calculatorBMI():
    bmi = calculatorBMI(150, 5, 10)
    assert round(bmi, 1) == 18.5

def test_calculatorBMI():
    bmi = calculatorBMI(200, 5, 10)
    assert round(bmi, 1) == 28.5